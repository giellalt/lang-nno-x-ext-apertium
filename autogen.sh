...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_nno to login script."
...
# the current dir:
if   test x${GTLANG_nno} = x ; then
	echo "WARNING: The variable \${GTLANG_nno} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_nno} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_nno} has the value:"
	echo "  ${GTLANG_nno}"
